...
| 3 | Eyestay Opening Width | CAM3 상부 | **미계측** — 상부 뷰 없음 |
| 4 | Forefoot Mudguard Distance | CAM6/7 측면 | **계측** — 스케일에 가장 강건 |
| 5 | Heel Mudguard Distance | CAM6/7 측면 | **계측** |
| 6 | Heel Height | CAM4 후면 | 측면 실루엣 기준 근사 |
| 7 | Heel Overlay Distance | CAM4 후면 | 두 사선 교점 근사 |
| 8 | Heel Center | CAM4 후면 | **미계측** — 후면 뷰 없음 |
| 9 | Strobel(중창) 검사 | CAM5 하부 | **미계측** — 하부 뷰 없음 |
| 10 | 타색상 검사 가능성 | — | 정반사 비율·텍스처 에너지로 정량화 |
| 11 | 검정색 검사 가능성 | — | 암부 에지 SNR 상대비로 정량화 |

미계측 항목도 알고리즘은 구현되어 있고, 요구 카메라와 사유를 화면에 표시합니다.
